...
myserial.println(longi); myserial.printIn("​http://maps.google.com/maps?&z=15&mrt=yp&t=k&q=​");
myserial.println("Accident detected at this location. Please send help");
  myserial.write(26);
  updateserial();
 }
 void updateserial()
